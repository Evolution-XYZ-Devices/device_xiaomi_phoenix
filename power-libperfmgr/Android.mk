...
LOCAL_MODULE := android.hardware.power-service.phoenix-libperfmgr
LOCAL_INIT_RC := android.hardware.power-service.phoenix-libperfmgr.rc
LOCAL_MODULE_TAGS := optional
LOCAL_VENDOR_MODULE := true
LOCAL_VINTF_FRAGMENTS := android.hardware.power-service.phoenix.xml
